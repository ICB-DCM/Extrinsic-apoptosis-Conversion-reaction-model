function [model] = model_C8S_A_PA_syms()
    ...
    % p = [KDR KDL kon_FADD koff_FADD kon_p55 kpd_cis ked_tr_p55 ked_tr_p43 kp18i kBID kprobes...
    %      CD95_0A CD95_0H FADD_0 p55_0 BID_0 PrERF1_0 PrNESF2_0 volume_0 tBID_tapt...
    %      s_c8 s_GFP s_mCh s_FC8 s_FB];
    ...
    y = sym(zeros(6,1));
    % western blot
    y(1) = volume_0*(p55+DISCp55);
    y(2) = volume_0*p43;
    y(3) = volume_0*p30;
    y(4) = volume_0*(p18+p18i);
    y(5) = volume_0*BID;
    y(6) = volume_0*tBID;
    %% SYSTEM STRUCT
    model.sym.x = x;
