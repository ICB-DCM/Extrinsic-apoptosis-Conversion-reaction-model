% simulate_model_caspase8.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_model_caspase8(tout,theta)
% [...] = simulate_model_caspase8(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_model_caspase8(...)
%
% INPUTS:
% =======
...
function varargout = simulate_model_caspase8(varargin)
...
if(max(options_ami.sens_ind)>21)
...
sol = ami_model_caspase8(tout,theta(1:21),kappa(1:1),options_ami,plist,xscale,init,data);
if(nargout>1)
